  ...
  return (
    <div className="main">
      ...
      <div className="graphs-section">
        <div>
          <img src={GrantRatesByOfficeImg} alt='bar-graph' className='bar-graph'/>
          <p>Search Rates By Office</p>
        </div>
        ...
        <div className='data-container'>
          ...
          <div>
            ...
            <h3> 
              ...
              percent in the fiscal year 2020.
            </h3>
          </div>
          <div>
            <h2>6x Lower</h2>
            <h3>
              ...
              than the San fancisco asylum office.
            </h3>
          </div>
        </div>
